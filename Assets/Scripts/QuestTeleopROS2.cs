...
namespace ROS2
{
    public class QuestTeleopROS2 : MonoBehaviour
    {
        ...
        [Header("Frecuencia de publicación")]
        ...
        void Update()
        {
            ...
            // 4. Control de frecuencia de publicaci�n
        ...
        // M�todo p�blico para conectar con el Toggle de la UI
